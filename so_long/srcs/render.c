...
/*   Updated: 2023/11/26 00:02:49 by pgonzalez        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (data->map[x][y] == '0')
		mlx_put_image_to_window(data->mlxp, data->winp, data->empty, y * 40, x
			* 40);
	else if (data->map[x][y] == '1')
		mlx_put_image_to_window(data->mlxp, data->winp, data->wall, y * 40, x
			* 40);
	else if (data->map[x][y] == 'P')
		mlx_put_image_to_window(data->mlxp, data->winp, data->player, y * 40, x
			* 40);
	else if (data->map[x][y] == 'C')
		mlx_put_image_to_window(data->mlxp, data->winp, data->collectable, y
			* 40, x * 40);
	else if (data->map[x][y] == 'E')
		mlx_put_image_to_window(data->mlxp, data->winp, data->exit, y * 40, x
			* 40);
}
